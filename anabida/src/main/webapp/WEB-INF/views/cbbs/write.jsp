...
<main>
	<div class="container body-container">
	    <div class="body-title">
			<h2><i class="fa-regular fa-square"></i> 커뮤니티 게시판 </h2>
	    </div>
				...
				<table class="table">
					<tr> 
						<td align="center">
							...
							<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/bbs/list.do';">${mode=='update' ?"수정완료":"등록완료"}</button>
