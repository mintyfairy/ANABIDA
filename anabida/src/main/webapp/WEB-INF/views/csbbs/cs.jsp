	...
	<main>
		<div class="container body-container">
			<div class="body-title">
				<h2>
					<i class="fa-regular fa-square"></i> 게시판
				</h2>
			</div>
					...
					<tr>
						<td width="100">
							<button type="button" class="btn"
								onclick="location.href='${pageContext.request.contextPath}/bbs/list.do';"
								title="새로고침">
						...
						<td align="center">
							<form name="searchForm" action="" method="post">
								...
								</select> <input type="text" name="kwd" value="" class="form-control">
